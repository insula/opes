...
import br.com.insula.opes.TituloEleitor;

public class TituloEleitorUserType extends ImmutableUserType {
	...
	public Object nullSafeGet(ResultSet rs, String[] names, Object owner) throws HibernateException, SQLException {
		...
		if (rs.wasNull()) {
			...
			return TituloEleitor.fromString(value);
		}
	}
	...
	public void nullSafeSet(PreparedStatement st, Object value, int index) throws HibernateException, SQLException {
		if (value == null) {
			...
			TituloEleitor tituloEleitor = (TituloEleitor) value;
			st.setString(index, tituloEleitor.toString());
		}
	}
